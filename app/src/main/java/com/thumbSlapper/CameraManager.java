...
public final class CameraManager {
    ...
    public void doTakeAPicture(Camera.PictureCallback maPicture) {
                System.out.println("doTakeAPicture");
        try {
        Camera theCamera = camera;
            // User can decide through native settings to silence phone
            ...
            theCamera.takePicture(null, null, maPicture, maPicture);
    ...
    public void setPicString(String ts) {
    bencodedImage = ts;
   }
   public Point getPicRes() {
